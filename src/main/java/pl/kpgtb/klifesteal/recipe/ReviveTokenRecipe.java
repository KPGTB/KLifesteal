...
public class ReviveTokenRecipe extends KRecipe {
    private final NamespacedKey key;
    private final LifestealWrapper wrapper;

    public ReviveTokenRecipe(NamespacedKey recipeKey, ToolsObjectWrapper toolsObjectWrapper) {
    ...
    public Recipe getRecipe() {
        ShapedRecipe recipe = new ShapedRecipe(key,wrapper.getItemManager().getCustomItem(wrapper.getTag(), ReviveTotemItem.class));
        recipe.shape(" s ", "shs", " s ");
